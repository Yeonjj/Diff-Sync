...
// is it better to be created everytime test() done
const diff_match_patch = require("../diff-match-patch.js")
const dmp = new diff_match_patch()

describe('DS component ',()=>{
    const DS_test = require("../ds.js")
    test('is created', ()=>{
        expect(DS_test).toBeDefined()
    })
    test('diffs and patchs two different contents and make result as a string', ()=>{
        DS_test.diff("cat","cats")
        expect(DS_test.patch("Cat")).toBe("Cats")
    })
})
